      ...
      <div class="md:w-1/2 p-4 flex flex-col">
        ...
        {#if isSoldOut}
          <div class="grow flex flex-col gap-4 justify-center px-6">
            ...
            <p>
              Cohort 1 of sediment art has sold out, but there will be more!
            </p>
        ...
        {:else}
          <div class="grow flex flex-col gap-4 justify-center px-6">
            ...
            <p>
              Sediment Art is live, our first run of cohort 1 will only have 10
              orders available, so make sure to order soon!
            </p>
            <p>
              Every order of a Medium size (11x14 or 11x11) will receive free
              exclusive print!
            </p>
            <div>
              <Button
