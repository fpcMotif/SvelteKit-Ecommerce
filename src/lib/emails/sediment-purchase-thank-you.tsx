				...
				<Body className="bg-white my-auto mx-auto font-sans px-2">
					<Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] max-w-[465px]">
						...
						<Text className="text-black text-[14px] leading-[24px]">
							You are one of the very first (among the first 10) to order from us, and we could not be more
							grateful. We have included for free an exclusive piece from a currently unreleased collection
							that will be sent with your order.
						</Text>
						<Text className="text-black text-[14px] leading-[24px]">
							We're thrilled to be getting one of our pieces in your hands. We'll keep you updated as we
							get your order fulfilled.
						</Text>
						<Text className="text-black text-[14px] leading-[24px]">
							Remember that our pieces are made to order, so expect at least a week before your's arrives.
						</Text>
						<Text className="text-black text-[14px] leading-[24px]">
							We use Fracture for our fulfillment, so your package will arrive in Fracture packaging, as
							they have the best systems in place for keeping your glass pristine!
						</Text>
