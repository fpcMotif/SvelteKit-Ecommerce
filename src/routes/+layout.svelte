...
<svelte:head>
  ...
  />
  <meta property="og:title" content="Sediment Art, Beauty Crystalized" />
  <meta
    property="og:description"
    content="Sediment Art, beauty crystalized and shipped straight to you."
  />
  <!-- TODO: Add og:image after Cloudinary configuration -->
</svelte:head>

<!-- TODO: Uncomment after Cloudinary configuration -->
<!--
<CldOgImage
...
<body class="flex justify-between w-full flex-col min-h-screen">
  <div
    ...
    id="mobile-nav"
  >
    <button on:click={() => handleRemoveMobile()} aria-label="Close menu">
      <svg
        width="24"
        height="24"
        viewBox="0 0 24 24"
    ...
    {#each data.collections as collection}
      <div>
        <a href={"/products?tag=" + collection.collection}
  ...
  >
    <Alert.Root class="w-[500px] bg-black text-white max-w-[100vw]">
      ...
      <Alert.Description
        >Please proceed to the cart to checkout.</Alert.Description
      >
    </Alert.Root>
  </div>
