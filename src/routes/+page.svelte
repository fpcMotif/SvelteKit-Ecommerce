...
<main class="grow">
  <div class=" w-full relative">
    ...
    >
      ...
      <h4 class="font-light sm:text-3xl text-xl font-jura">
        Beauty. Crystallized.
      </h4>
      <a
  ...
  <div class="w-full flex flex-col py-4 px-2 bg-black text-white">
    <h3 class="text-center font-jura text-5xl pb-8 px-3">
      What is Sediment Art?
    </h3>
    <p class="text-center text-lg font-light pb-4 px-3">
      We take photos of the natural beauty in nature and the world, and print
      them onto glass for you to display in your home or office.
    </p>
  ...
  <div class="w-full md:w-3/4 m-auto">
    <h2 class="font-jura sm:text-4xl text-3xl text-center pt-8 pb-4">
      Natural Beauty in Glass
    </h2>
    <p class=" text-lg text-center px-4 md:px-16 font-light">
      What is this stunning artwork? They are photographs of rocks that are <span
        class="italic">millions</span
      >
      of years old, found in the United States,
      <span class="italic">sliced and polished by hand.</span> Each rock has a unique
      story to tell. James Cunningham Photography has turned them into works of art
      for your home.
    </p>
    <h2 class="font-jura sm:text-4xl text-3xl text-center pt-8 pb-4">
      Our Process
    ...
    <p class=" text-lg text-center px-4 md:px-16 font-light pb-8">
      Each piece is made to order, so once you order we will create your piece,
      get it packaged, then have it sent out.
    </p>
  </div>
